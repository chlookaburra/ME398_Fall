...
def main(A, omega, epsilon, t0, t1, dt, width, height):
    ...
    load_file = '/Users/chloe/Documents/Stanford/ME398_Fall/Python_Tutorial/saveExplore/fields_A'+str(A)+'_eps'+str(epsilon)+'_omega'+str(round(omega,2))+'_t'+str(t1)+'.mat'
    ...
    while conv >= 1e-4:
        ...
        ax.plot( lavd_x_max, lavd_y_max, marker="o", markersize=8, markeredgecolor="cyan", markerfacecolor="cyan" )
        ...
        ax.plot(camera.x, camera.y, marker="o", markersize=8, markeredgecolor="red", markerfacecolor="red")
        ...
        ax.plot(camera.x, camera.y, marker="o", markersize=8, markeredgecolor="hotpink", markerfacecolor="hotpink")
